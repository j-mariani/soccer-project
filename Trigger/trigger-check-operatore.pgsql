create or replace function controllo_permessi_operatore() returns trigger as $$
declare
    ic_id incontri.id%type;
...
create TRIGGER check_operazioni_operatore before insert or update or delete on incontri for each row execute procedure controllo_permessi_operatore();
